...
/*        createOrder("두부", 2000, 2);
    ...
    static ProductOrder createOrder(String productName, int price, int quantity) {
/*        Exception in thread "main" java.lang.NullPointerException: Cannot read field "productName" because "order" is null
        at ref.ex.ProductOrderMain2.printOrders(ProductOrderMain2.java:55)
        at ref.ex.ProductOrderMain2.main(ProductOrderMain2.java:36)*/
